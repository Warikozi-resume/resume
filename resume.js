...
var initProgram = setTimeout(function(){
    ...
    var $webDesign = "* Resolves static IP issues for enterprise and business customers.";
    var $manged = "* Conducts on-site technical assessments to identify misconfigurations in customer's network.";
    var $install = "* Implements quality assurance processes ensuring customer's issue resolution.";
    var $faciliate = "* Performes enterprise site surveys to analyze network topology.";
    var $custmer = "* Conducts on-site technical assessments and installations.";
    var $top = "* Achieved top-tier performance metrics with 96% productivity.";
    var $escal = "* Developed and implemented process improvements to reduce escalation.";
    var $branding = "Everise";
    var $designAnimation = "May 2021 - April 2022";
    var $rise = "Technical Support Agent - Network Security";
    var $para = "* Analyzed and resolved complex mesh network topology issues including DDNS setup.";
    var $issue = "* Led a team of 12+ technical specialists in systematic diagnostic approaches for mesh system failures.";
    var $advance = "* Developed comprehensive diagnostic methodology for identifying and resolving client issues.";
    var $rank = "* Ranked among top performers with first-call resolution rates exceeding 90%.";
    var $amazon = "* Managed Amazon Eero mesh system, resolving high-priority and connectivity cases monthly.";
    var $back = "* Reduced customer callback rate by high perecentage thorough root cause analysis and permanent remediation.";
    var $high = "* Maintained 90%+ customer satisfaction through clear technical communication of best practices.";
    var $led = "* Used optimization techniques to implement security hardening.";
    var $reso = "* Documented and standardized troubleshooting procedures for recurring network incidents.";
    var $h = "Profile";
    var $habitpara = "Dedicated and results-driven computer science student with a degree in software development and security speciallizes in cyber operations. Designed and implemented secure applications, optimized network performance, and resolved complex technical issues. Committed to continuous learning and staying ahead of emerging threats and technologies in the cybersecurity landscape.";
    var $myname = "Boney Warikozi";
    var $myemail = "Boney.Warikozi@gmail.com";
    var $website = "https://security-eng.netlify.app";
    var $github = " GitHub: ";
    var $resume = "Resume: ";
    var $phone = "501-333-4371";
